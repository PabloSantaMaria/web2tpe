          ...
          <div class="card-body">
            ...
            <form class="form-inline" method="post" action="adminDisplay">
              <div class="form-group mb-2">
                ...
                <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Ver acciones por región">
              </div>
            ...
            <form class="form-inline" method="post" action="adminDisplay">
              <div class="form-group mb-2">
                <label for="staticEmail2" class="sr-only">Email</label>
                <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Ver acciones por país">
              </div>
              <div class="form-group mx-sm-3 mb-2">
